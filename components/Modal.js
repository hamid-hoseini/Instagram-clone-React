...
function Modal() {
  ...
  const uploadPost = async() => {
    ...
    // 4) Get a download URL fb storage and update the original post with image
            ...
            <div>
              {selectedFile ? (
                ...
                <div onClick={() => filePickerRef.current.click()} className='mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 cursor-pointer'>
                  <CameraIcon className='h-6 w-6 text-red-600' aria-hidden/>
                </div>
              )}
              ...
              <div>
                <div className='mt-3 text-center sm:mt-5'>
                  ...
                  <div>
                    <input ref={filePickerRef} type="file" hidden onChange={addImpageToPost}/>
                  </div>
                  <div className='mt-2'>
                    <input className="border-none focus:ring-0 w-full text-center outline-none" type="text"
