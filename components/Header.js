      ...
      <div className='flex justify-between bg-white max-w-6xl mx-5 lg:mx-auto'>
        ...
        <div className='max-w-xs'>
          <div className='relative mt-1 p-3 rounded-md'>
            ...
            <input className='bg-gray-50 block w-full pl-10  py-2 pr-2 sm:text-sm border-gray-300 focus:ring-black focus:border-black rounded-md' type="text" placeholder='Search' />
          </div>
        </div>
        {/* Right */} 
